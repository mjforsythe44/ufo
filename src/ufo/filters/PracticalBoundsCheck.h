...
/// Parameters controlling the operation of the PracticalBoundsCheck filter.
...
///
/// See PracticalBoundsCheckParameters for documentation of parameters controlling this filter.
